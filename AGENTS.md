...
**Suche:** Client-Index `/js/search-index.json` + `/js/search.js` (Navbar + `/suche.html`). Nach neuen Artikeln/Glossar-Terms: `python tools/build_search_index.py` im Website-Root, dann Sync-Ende. Kein Backend.
